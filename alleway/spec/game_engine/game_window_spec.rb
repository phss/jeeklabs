...
describe Engine::GameWindow do
  
  before(:each) do
    @game_window = Engine::GameWindow.new("Test", 640, 480)
  end
...
class FirstStubScreen < Engine::Screen; end
class SecondStubScreen < Engine::Screen; end
class ThirdStubScreen < Engine::Screen; end